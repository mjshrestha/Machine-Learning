...
public class diabetes_ga_hw2 {
    ...
    public static void main(String[] args) {
		...
		int[] population = {100,100,100,100};
		int[] mate = {10,10,30,30};
		int[] mute = {10,30,10,30};
        ...
        for (int trainingIterations : iterations) {
            ...
            for (int q = 0; q < population.length; q++) {
                ...
                write_output_to_file("Results", "diabetes_results_ga.csv", final_result, true);
