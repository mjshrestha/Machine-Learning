 ...
 * @version 1.0
 */
public class TravelingSalesman_hw2 {
    /** The n value */
    ...
    public static void main(String[] args) {
        ...
        /*for (int iter : iters) {
           ...
           for (int j = 0; j < testRuns; j++) {
            ...
            write_output_to_file("Results", "travelingsalesman_results.csv", final_result, true);
        }*/
		
		
         int[] population = {200,200,200,200,200,200,200,200,200};
		 int[] mate = {50,50,50,100,100,100,150,150,150};
		 int[] mute = {10,20,30,10,20,30,10,20,30};
		 /*int[] population = {200,200,200,200,200,200};
		 int[] mate = {10,10,30,30,50,50};
		 int[] mute = {10,30,10,30,10,30};*/
         double sum_ga = 0;
         double time_ga = 0;
         ...
         System.out.println("*********************");
		 System.out.println("Population size: " + population[i] + ", Mating size: " + mate[i] + ", Mutation size: " + mute[i]);
         System.out.println("GA average: " + average_ga + "," + ", time average: " + averagetime_ga);

         String final_result = "";
         final_result = "ga" + "," + population[i] + "," + mate[i] + "," + mute[i] + "," + Double.toString(average_ga) + "," + Double.toString(averagetime_ga);

         write_output_to_file("Results", "travelingsalesman_ga_results.csv", final_result, true);
         }
