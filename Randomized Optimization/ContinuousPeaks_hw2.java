 ...
 * @version 1.0
 */
public class ContinuousPeaks_hw2 {
    /** The n value */
    ...
    public static void main(String[] args) {
        ...
        /*for (int iter : iters) {
            ...
            write_output_to_file("Results", "continuousPeaks_results.csv", final_result, true);
        }
		*/
		
        //double[] temp = {1E10, 1E11, 1E12, 1E10, 1E11, 1E12, 1E10, 1E11, 1E12};
		//double[] coolings = {0.25, 0.25, 0.25, 0.65, 0.65, 0.65, 0.95, 0.95, 0.95};
		double[] temp = {1E10, 1E10, 1E10, 1E11, 1E11, 1E11, 1E12, 1E12, 1E12};
		double[] coolings = {0.15, 0.55, 0.95, 0.15, 0.55, 0.95, 0.15, 0.55, 0.95};
        ...
        for (int i = 0; i < coolings.length; i++){
            ...
            for (int j = 0; j < testRuns; j++) {
                ...
                start = System.nanoTime();
                SimulatedAnnealing sa = new SimulatedAnnealing(temp[i], coolings[i], hcp);
            ...
            double averagetime_sa = time_sa / testRuns;
            System.out.println("**************************");
            System.out.println("Cooling: " + coolings[i] + " Temperature: " + temp[i]);
            System.out.println("SA average fitness: " + average_sa + ", average time : " + averagetime_sa);
            String final_result = "";
            final_result =
                    "SA" + "," + Double.toString(coolings[i]) + "," + Double.toString(temp[i]) + "," + Integer.toString(average_sa) + "," + Double.toString(averagetime_sa);
            write_output_to_file("Results", "continuousPeaks_sa_results.csv", final_result, true);
        }
